...
# for data in "inspec" "krapivin"
  do
    ...
    python evaluate_llm_test.py \
        --model_type $model_type \
        --data_dir ${data_dir} \
        --test_output_dir  "./llm_results/output_${model_type}/${model_type}_${data}_pre.txt" \
        --test_output_dir2 "./llm_results/output_${model_type}/${model_type}_${data}_abs.txt" \
        --paradigm ${paradigm} \
        --beam_size ${beam_size} \
