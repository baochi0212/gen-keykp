...
for data in "kp20k"
  do
    ...
    python evaluate_llm_valid.py \
        --model_type $model_type \
        --data_dir ${data_dir} \
        --test_output_dir  "./llm_valid_results/output_${model_type}/${model_type}_${data}_pre.txt" \
        --test_output_dir2 "./llm_valid_results/output_${model_type}/${model_type}_${data}_abs.txt" \
        --paradigm ${paradigm} \
        --beam_size ${beam_size} \
